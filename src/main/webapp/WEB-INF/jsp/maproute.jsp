					...
					<div class="accordion md-accordion" id="accordion-select">
						...
						<div class="card">
							...
							<div id="col-selectDep" class="collapse show"
								...
								<div class="card-footer">
									...
									<button class="btn btn-primary next" type="button">다음
									</button>
								</div>
							</div>
						</div>
							...
							<div id="col-selectBranch" class="collapse"
								...
								<div class="card-footer">
									<button class="btn btn-primary" type="button"
										...
										이전</button>
									<button class="btn btn-primary next" id="resultButton"
						...
						<div class="card">
							...
							<div id="col-selectRoad" class="collapse"
								...
								<div class="card-footer">
									<button class="btn btn-primary" id="resultPrev" type="button"
										data-toggle="collapse" data-target="#col-selectBranch"
										aria-expanded="false" aria-controls="col-selectBranch">
										이전</button>
							...
							<div id="col-selectBranch" class="collapse"
								...
								<div class="card-footer text-right">
									<button class="btn btn-outline-success" type="button"
										...
										aria-expanded="false" aria-controls="col-selectDate">
										이전</button>
									<button class="btn bg-olive next" id="resultButton"
										type="button">다음</button>
								</div>
							</div>
						</div>
