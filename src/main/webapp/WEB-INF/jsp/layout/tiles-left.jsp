...
<aside class="main-sidebar elevation-4 sidebar-dark-yellow">
	<!-- Brand Logo -->
	<a href="/home" class="brand-link navbar-olive"> <img
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column nav-legacy"
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item"><a id="/home" onClick="changeView(this)" class="nav-link active">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>홈</p>
				</a></li>

				<li class="nav-item"><a id="/maproute" onClick="changeView(this)" class="nav-link">
						<i class="nav-icon fas fa-truck"></i>
						<p>경로탐색</p>
				</a></li>

				<li class="nav-item"><a id="/history" onClick="changeView(this)" class="nav-link"> <i
						class="nav-icon fas fa-book"></i>
						<p>조회내역</p>
				</a></li>

				<li class="nav-item"><a id="/hierarchy" onClick="changeView(this)" class="nav-link">
