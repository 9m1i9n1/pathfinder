...
public class HomeController {
	...
	public Header<List<HistoryResponse>> recentlyHistory(@PageableDefault(size = 5) Pageable pageable) {
	...
	public Header<List<HistoryResponse>> todayHistory(@PageableDefault(size = 5) Pageable pageable) {
		System.out.println("ggood");
		System.out.println(pageable);
