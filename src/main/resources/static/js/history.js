	...
	$("#calendar").calendar(
			{
				...
				monthArray : [ "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월",
						"9월", "10월", "11월", "12월" ],
						...
						$
								.each(
										...
										function(key, value) {
											...
											str += "<td>" + value.regdate
													+ "</td>";
											str += "<td>" + value.username
													+ "</td>";
											str += "<td>" + value.dep + "</td>";
											str += "<td>" + value.arvl
													+ "</td>";
											str += "<td>" + value.dlvrdate
													+ "</td>";
											str += "<td>" + value.arrivedate
													+ "</td>";
											str += "<td>" + value.carname
													+ "</td>";
	...
	$.ajax({
		...
		success : function(res) {
			...
			$.each(res.data, function(key, value) {
				str += `<tr class="tr-shadow small" id="ModalTr">`;
				str += "<td>" + ++count + "</td>";
